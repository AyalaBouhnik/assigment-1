...
class WGraph_AlgoTest {
    ...
    void isConnected() {
        ...
        g0 = DS_Ayala_test.graph_creator(1,0,1);
        ag0 = new WGraph_Algo();
        ag0.init(g0);
        assertTrue(ag0.isConnected());

        g0 = DS_Ayala_test.graph_creator(2,0,1);
        ag0 = new WGraph_Algo();
        ag0.init(g0);
    ...
    @Test
    void save_load() {
        weighted_graph g0 = DS_Ayala_test.graph_creator(10,30,1);
        weighted_graph_algorithms ag0 = new WGraph_Algo();
        ag0.init(g0);
        String str = "g0.obj";
        ag0.save(str);
        weighted_graph g1 = DS_Ayala_test.graph_creator(10,30,1);
        ag0.load(str);
        assertEquals(g0,g1);
        g0.removeNode(0);
    ...
    private weighted_graph small_graph() {
        weighted_graph g0 = DS_Ayala_test.graph_creator(11,0,1);
        g0.connect(0,1,1);
        g0.connect(0,2,2);
        g0.connect(0,3,3);
